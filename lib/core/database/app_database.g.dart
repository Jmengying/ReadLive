...
class $BooksTableTable extends BooksTable
  ...
  static const VerificationMeta _bookProgressMeta =
      const VerificationMeta('bookProgress');
  @override
  late final GeneratedColumn<double> bookProgress = GeneratedColumn<double>(
      'book_progress', aliasedName, false,
      type: DriftSqlType.double,
      requiredDuringInsert: false,
      defaultValue: const Constant(0.0));
    ...
    if (data.containsKey('book_progress')) {
      context.handle(
          ...
          bookProgress.isAcceptableOrUnknown(
              data['book_progress']!, _bookProgressMeta));
    }
  ...
  BooksTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return BooksTableData(
      ...
      bookProgress: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}book_progress'])!,
...
class BooksTableData extends DataClass implements Insertable<BooksTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['book_progress'] = Variable<double>(bookProgress);
  ...
  factory BooksTableData.fromJson(Map<String, dynamic> json,
    ...
    return BooksTableData(
      ...
      bookProgress: serializer.fromJson<double>(json['bookProgress']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'bookProgress': serializer.toJson<double>(bookProgress),
...
class BooksTableCompanion extends UpdateCompanion<BooksTableData> {
  ...
  final Value<double> bookProgress;
  ...
  static Insertable<BooksTableData> custom({
    ...
    Expression<double>? bookProgress,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (bookProgress.present) {
      map['book_progress'] = Variable<double>(bookProgress.value);
    }
...
class $$BooksTableTableFilterComposer
  ...
  ColumnFilters<double> get bookProgress => $composableBuilder(
      column: $table.bookProgress, builder: (column) => ColumnFilters(column));
...
class $$BooksTableTableOrderingComposer
  ...
  ColumnOrderings<double> get bookProgress => $composableBuilder(
...
class $$BooksTableTableAnnotationComposer
  ...
  GeneratedColumn<double> get bookProgress => $composableBuilder(
      column: $table.bookProgress, builder: (column) => column);
  ...
  $$BooksTableTableTableManager(_$AppDatabase db, $BooksTableTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<double> bookProgress = const Value.absent(),
